//
// Generated file, do not edit! Created by nedtool 5.5 from msg/Ack.msg.
//
...
int AckDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='a' && strcmp(fieldName, "ackedMessageId")==0) return base+0;
...
std::string AckDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Ack *pp = (Ack *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getAckedMessageId());
...
bool AckDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Ack *pp = (Ack *)object; (void)pp;
    switch (field) {
        case 0: pp->setAckedMessageId(string2long(value)); return true;
